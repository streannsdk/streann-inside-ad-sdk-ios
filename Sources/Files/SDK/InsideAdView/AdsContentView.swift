...
struct AdsContentView: View {
    ...
    var body: some View {
        ...
        .onReceive(campaignManager.$fetchCompleted) { newValue in
            self.findActiveAdForScreen()
        }
        ...
        .onDisappear{
            ...
            if !campaignManager.isDeviceRotated {
                print(Logger.log("DEBUG: AdsContentView Disappeared"))
    ...
    private func findActiveAdForScreen(){
        ...
        if (adsManager.insideAdCallback == .UNKNOWN || adsManager.insideAdCallback == .ALL_ADS_COMPLETED) && adsManager.timerNextAd == nil{
